...
This project groups together R-based statistical analysis materials that best align with the `Population Health Statistical Analysis` project listed on my resume.
...
- Statistical interpretation for decision-making
- R-based exploratory and analytical workflow
- Written communication of quantitative findings
